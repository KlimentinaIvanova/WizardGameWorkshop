...
function gameLoop(state, game, timestamp) {
    ...
    if (state.keys.Space) {
        game.wizardElement.style.backgroundImage = 'url("/src/css/images/wizard-fire.png")';
        ...
        game.wizardElement.style.backgroundImage = 'url("mainjs/src/css/images/wizard.png")';
    }
